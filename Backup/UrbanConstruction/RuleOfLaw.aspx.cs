...
{
    public partial class RuleOfLaw : System.Web.UI.Page
    {
        ...
        public void Bind()
        {
            ...
            newsList = idal.FindAll(15,pageIndex,1,string.Format("kind={0} and state={1}",(int)EnumType.KindType.政策法规,(int)EnumType.StateType.已审核),"ID").ToList();

            int Count = idal.FindAll(string.Format("kind={0} and state={1}", (int)EnumType.KindType.政策法规, (int)EnumType.StateType.已审核));
