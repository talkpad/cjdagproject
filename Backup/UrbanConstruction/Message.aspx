<%@ Page Language="C#" MasterPageFile="~/WebSite.Master" AutoEventWireup="true" CodeBehind="Message.aspx.cs"
    Inherits="UrbanConstruction.Message" Title="公共互动" %>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#mySelect").change(function() {
                window.location.href = "Message.aspx?pageIndex=" + $("#mySelect").val() + "";
            });
        });
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="middle">
        <!--S中间内容区域-->
        <p class="dw">
            您现在的位置： <a href="index.aspx">首页</a>&nbsp;&nbsp;<span>&gt;&gt;</span>&nbsp;&nbsp;咨询内容</p>
        <div class="List">
            <!--S列表内容-->
            <div class="ListL">
                <div class="LZCFG">
                    ...
                    <h2>
                        <span>咨询内容</span></h2>
                    <ul>
                        <li><a href="MessageAdd.aspx" target="_blank">我要咨询</a></li>
                        <li><a href="MessageList.aspx" class="SZ" target="_blank">咨询列表</a></li>
                    </ul>
                </div>
                <!--E在线咨询-->
                <div class="LPIC">
                        ...
                        <ItemTemplate>
                            <div style="margin-bottom: 8px; border: 1px solid #c6c6c6;">
                                ...
                                <div style="height: 29px; line-height: 29px; background: url(images/ZXZXList_title.jpg) left top no-repeat;">
                                    <!--Title-->
                                    <h3 style="float: left; padding-left: 27px; width: 225px; height: 29px; color: #043173;
                                        font-size: 14px;">
                                        <%# Eval("Name")%></h3>
                                ...
                                <div style="padding-bottom: 5px; background: url(images/ZXZXList_wenBg.jpg) left top repeat-x #f1f1f1;">
                                    ...
                                    <p style="float: left; padding-top: 5px; width: 690px; line-height: 24px; color: #043173;">
                                ...
                                <div style="border-top: 1px solid #c2c3c4; padding-bottom: 5px;">
                                    ...
                                    <div style="float: left; padding-top: 5px; width: 690px; line-height: 24px;">
