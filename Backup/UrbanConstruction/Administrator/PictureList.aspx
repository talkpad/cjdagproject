<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PictureList.aspx.cs" Inherits="UrbanConstruction.Administrator.PictureList" %>
...
<script type="text/javascript" src="js/Admin/PictureList.js"></script>
  <script type="text/javascript">
      ...
      <script type="text/javascript">
        $(document).ready(function() {
            ...
            window.location.href = "PictureList.aspx?pageIndex=" + $("#mySelect").val() + "";
            });
        });
    </script>
</head>
        ...
        <asp:Repeater ID="Rplist" runat="server" OnItemCommand="Rplist_ItemCommand" OnItemDataBound="Rplist_ItemDataBound">
            <ItemTemplate>
                <tr align='center' height="22">
                    <td valign="middle" align="left" style="padding-left: 5px;" title="<%# Eval("PictureName") %>">
                        <%# SZM.Utility.Library.FunHelper.GetString(Eval("PictureName"), 70, true)%>
                    </td>
                    ...
                    <td valign="middle">
                         <%--<asp:HyperLink ID="lbtnEdit" identity='<%# Eval("PictureID")%>' NavigateUrl='<%#Eval("PictureID", "EditPicture.aspx?id={0}")%>' runat="server">修改</asp:HyperLink>--%>
                         <a  href="javascript:void(0)" title="change" onclick="self.parent.addTab('修改<%# Eval("PictureID")%>','<%#Eval("PictureID", "EditPicture.aspx?id={0}")%>','icon-edit')">修改</a>
                        <asp:LinkButton ID="lbtnDel" CommandArgument='<%# Eval("PictureID")%>' CommandName="del"
