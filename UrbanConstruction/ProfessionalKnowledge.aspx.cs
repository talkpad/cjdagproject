...
{
    public partial class ProfessionalKnowledge : System.Web.UI.Page
    {
        ...
        public void Bind()
        {
            ...
            newsList = idal.FindAll(15, pageIndex, 1, string.Format("kind={0} and state={1}", (int)EnumType.KindType.业务知识, (int)EnumType.StateType.已审核), "ID").ToList();

            int Count = idal.FindAll( string.Format("kind={0} and state={1}", (int)EnumType.KindType.业务知识, (int)EnumType.StateType.已审核));
