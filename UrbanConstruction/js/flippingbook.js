...
//			zoomImageHeight: 1165,
			...
			backgroundImage: "images/bookBackground.jpg",
...
FlippingBook.prototype.create = function(){
	...
	swfobject.embedSWF("images/FlippingBook.swf", this.containerId, this.stageWidth, this.stageHeight, "8.0.0", "js/expressInstall.swf", this.settings, {allowScriptAccess: "always", bgcolor:  "#" + this.settings.backgroundColor.toString( 16 ) });
}
