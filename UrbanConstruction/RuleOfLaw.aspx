<%@ Page Language="C#" MasterPageFile="~/WebSite.Master" AutoEventWireup="true" CodeBehind="RuleOfLaw.aspx.cs" Inherits="UrbanConstruction.RuleOfLaw" Title="法律法规" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script src="js/jquery-1.9.1.js" type="text/javascript"></script>
<script type="text/javascript">
    $(document).ready(function() {
        $("#mySelect").change(function() {
            window.location.href = "ruleOfLaw.aspx?pageIndex=" + $("#mySelect").val() + "";
        });
    });
</script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <div class="middle"><!--S中间内容区域-->
    	<p class="dw">您现在的位置： <a href="index.aspx">首页</a>&nbsp;&nbsp;<span>&gt;&gt;</span>&nbsp;&nbsp;法律法规</p>
        ...
        <ul>
            ...
            <div class="ListR">
               ...
               <a href="NewsDetail.aspx?FID=<%=newsList[i].ID.ToString()%>" target="_blank">
                ...
                <%else
                    { %>
                     <a href="ruleOfLaw.aspx?pageIndex=1">第一页</a>&nbsp;&nbsp;
                     <a href="ruleOfLaw.aspx?pageIndex=<%=pageIndex-1 %>">上一页</a>&nbsp;&nbsp;
                <%} %>
                ...
                <%else
                    { %>
                      <a href="ruleOfLaw.aspx?pageIndex=<%=pageIndex+1 %>">下一页</a>&nbsp;&nbsp;
                      <a href="ruleOfLaw.aspx?pageIndex=<%=pageCount %>">尾页</a>&nbsp;&nbsp;
                <%} %>
