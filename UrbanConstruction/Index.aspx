    ...
    <div class="middle">
        ...
        <div class="middle0">
            ...
            <div class="mLeft">
                ...
                <div class="PIC">
                    <!--S专题栏目图-->
                    <div class="ZTnm02" style="height:211px;">
                         <a href="NewsDetail.aspx?FID=<%=zhuantiLeft.ID %>" target="_blank">
                            <img src="NewsFile/images/News/<%=zhuantiLeft.PictureURL %>" width="248" height="211" alt="专题" /></a></div>
                    <div>
            ...
            <div class="mRight">
                ...
                <div class="hand3">
                    <!--S行3 专题栏目位-->
                     <a href="NewsDetail.aspx?FID=<%=specialsubject.ID %>" target="_blank">
                        <img src="NewsFile/images/News/<%=specialsubject.PictureURL %>" width="726" height="66" alt="" /></a></div>
                <!--E行3 专题栏目位-->
                <div class="hand4Pic">
                    <!--S行4 网上展览-->
                    <h2>
